...
<div class="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
    <div class="md:flex md:items-center md:justify-between mb-6">
        <div class="min-w-0 flex-1">
            <h2 class="text-2xl font-bold leading-7 text-slate-900 sm:truncate sm:text-3xl sm:tracking-tight">Konfigurasi Global</h2>
            <p class="mt-1 text-sm text-slate-500">Pengaturan utama platform Makassar Ujian.</p>
        </div>
