                    ...
                    <table class="min-w-full divide-y divide-slate-300">
                        <thead>
                            <tr>
                                ...
                                <th scope="col" class="px-3 py-3.5 text-left text-sm font-semibold text-slate-900">Area/Wilayah</th>
                        ...
                        <tbody class="divide-y divide-slate-200">
                            ...
                            @empty
                            <tr>
                                <td colspan="5" class="py-6 text-center text-sm text-slate-500">Belum ada Admin FKGG terdaftar.</td>
                            </tr>
                            @endforelse
                        </tbody>
                    </table>
