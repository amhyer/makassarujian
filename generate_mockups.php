...
$pages = [
    'tenant/sekolah' => ['title' => 'Manajemen Sekolah', 'desc' => 'Kelola seluruh data sekolah yang terdaftar di platform Makassar Ujian.'],
    'tenant/fkgg' => ['title' => 'Manajemen FKGG', 'desc' => 'Kelola data Forum Kelompok Guru Gugus (FKGG).'],
    'tenant/aktivasi' => ['title' => 'Aktivasi & Status', 'desc' => 'Pantau status aktif dan perpanjangan tenant.'],
    'billing/paket' => ['title' => 'Paket & Harga', 'desc' => 'Konfigurasi paket langganan dan harga untuk tenant.'],
    'billing/tagihan' => ['title' => 'Manajemen Tagihan', 'desc' => 'Lihat dan kelola invoice yang ditagihkan.'],
    'billing/pembayaran' => ['title' => 'Riwayat Pembayaran', 'desc' => 'Pantau transaksi pembayaran dari sekolah.'],
    'billing/trial' => ['title' => 'Trial Management', 'desc' => 'Kelola masa uji coba untuk tenant baru.'],
    'ujian/bank-soal' => ['title' => 'Bank Soal FKGG', 'desc' => 'Repositori soal ujian yang disusun oleh FKGG.'],
    'ujian/distribusi' => ['title' => 'Distribusi Soal', 'desc' => 'Atur penyebaran soal ujian ke berbagai sekolah.'],
    'ujian/template' => ['title' => 'Template Ujian', 'desc' => 'Konfigurasi standar layout dan aturan ujian.'],
    'monitoring/ujian-berlangsung' => ['title' => 'Ujian Berlangsung', 'desc' => 'Pantau sesi ujian yang sedang berjalan secara real-time.'],
    'monitoring/aktivitas-siswa' => ['title' => 'Aktivitas Siswa', 'desc' => 'Log aktivitas siswa selama mengerjakan ujian.'],
    'monitoring/status-server' => ['title' => 'Status Server', 'desc' => 'Pantau beban dan kesehatan server ujian.'],
    'user-management/admin-sekolah' => ['title' => 'Admin Sekolah', 'desc' => 'Kelola akun admin untuk setiap sekolah.'],
    'user-management/admin-fkgg' => ['title' => 'Admin FKGG', 'desc' => 'Kelola akun admin untuk pengurus FKGG.'],
    'sistem/konfigurasi' => ['title' => 'Konfigurasi Global', 'desc' => 'Pengaturan utama platform Makassar Ujian.'],
    'sistem/role-permission' => ['title' => 'Role & Permission', 'desc' => 'Kelola hak akses dan wewenang pengguna.'],
    'sistem/audit-log' => ['title' => 'Audit Log', 'desc' => 'Catatan aktivitas sistem dan perubahan data.'],
    'support/broadcast' => ['title' => 'Pesan Broadcast', 'desc' => 'Kirim pengumuman massal ke seluruh tenant.'],
    'support/tiket' => ['title' => 'Tiket Bantuan', 'desc' => 'Tangani keluhan dan pertanyaan dari pengguna.']
];

foreach ($pages as $path => $data) {
    $parts = explode('/', $path);
    $dir = $viewsDir . '/' . $parts[0];
    if (!is_dir($dir)) {
        mkdir($dir, 0777, true);
    }
    
    $file = $viewsDir . '/' . $path . '.blade.php';
...
<div class="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
    <div class="md:flex md:items-center md:justify-between mb-6">
        <div class="min-w-0 flex-1">
            <h2 class="text-2xl font-bold leading-7 text-slate-900 sm:truncate sm:text-3xl sm:tracking-tight">{$data['title']}</h2>
            <p class="mt-1 text-sm text-slate-500">{$data['desc']}</p>
        </div>
...
echo "18 Views generated successfully.\n";
